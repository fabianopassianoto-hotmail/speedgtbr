...
Export da versão 32 do projeto Speed GT Brasil, preparado para Cloudflare
...
Este pacote usa wrangler.jsonc para publicação na Cloudflare e wrangler.local.jsonc para o D1 local.
