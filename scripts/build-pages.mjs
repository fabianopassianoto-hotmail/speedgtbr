...
try {
  ...
  await writeFile(join(stage, "_routes.json"), JSON.stringify({ version: 1, include: ["/ádmin", "/ádmin/", "/a%CC%81dmin", "/a%CC%81dmin/", "/ádmin", "/ádmin/", "/%C3%A1dmin", "/%C3%A1dmin/", "/comece-aqui", "/comece-aqui/", "/admin", "/admin/", "/cadastro", "/cadastro/", "/central", "/central/*", "/api/championships/*"], exclude: ["/central/assets/*", "/central/brand/*", "/central/og.png", "/central/favicon.svg"] }));
