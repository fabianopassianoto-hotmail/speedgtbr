...
try {
  ...
  await writeFile(join(stage, "_routes.json"), JSON.stringify({ version: 1, include: ["/cadastro", "/cadastro/", "/central", "/central/*", "/api/championships/*"], exclude: ["/central/assets/*", "/central/brand/*", "/central/og.png", "/central/favicon.svg"] }));
